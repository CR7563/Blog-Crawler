	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<div class="data_list">
				...
				<div class="hostDatas">
					<ul>
						<c:forEach var="article" items="${hotArticleList }" varStatus="status">
							<li><span><a href="${pageContext.request.contextPath}/article/${article.id }.html" title="${article.title }">${status.index+1}、${article.title }</a></span></li>
						</c:forEach>
					</ul>
				</div>
			</div>
