...
<table id="dg" title="帖子管理" class="easyui-datagrid"
   ...
   <thead>
   	<tr>
   		...
   		<th field="orUrl"  align="center">原始地址</th>
 ...
 <div id="tb">
 	<div>
 	    <a href="javascript:openArticleAddTab()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
