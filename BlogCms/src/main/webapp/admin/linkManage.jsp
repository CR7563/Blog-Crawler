...
<table id="dg" title="友情链接管理" class="easyui-datagrid"
   ...
   <thead>
   	<tr>
   		...
   		<th field="sortNo" width="50" align="center">排序序号</th>
   	</tr>
   </thead>
 </table>
 <div id="tb">
 ...
 <div id="dlg" class="easyui-dialog" style="width:500px;height:300px;padding: 10px 20px"
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		...
   		<tr>
   			<td>排序序号：</td>
   			<td><input type="text" id="sortNo" name="sortNo" class="easyui-numberbox" required="true" style="width: 60px"/>&nbsp;(类别根据排序序号从小到大排序)</td>
   		</tr>
   	</table>
   </form>
 </div>
